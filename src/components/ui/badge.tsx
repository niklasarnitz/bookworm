  ...
  "inline-flex items-center justify-center rounded-md border px-2.5 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden",
  {
    variants: {
      variant: {
        ...
        success:
          "border-transparent bg-green-500/20 text-green-700 dark:bg-green-500/30 dark:text-green-200 [a&]:hover:bg-green-500/30",
        info: "border-transparent bg-blue-500/20 text-blue-700 dark:bg-blue-500/30 dark:text-blue-200 [a&]:hover:bg-blue-500/30",
        warning:
          "border-transparent bg-yellow-500/20 text-yellow-700 dark:bg-yellow-500/30 dark:text-yellow-200 [a&]:hover:bg-yellow-500/30",
      },
    },
    defaultVariants: {
      variant: "default",
